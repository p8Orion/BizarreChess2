...
namespace BizarreChess.Core.Board
{
    ...
    public class BoardSkin
    {
        ...
        public TileStyle Impassable;        // Style for wall mesh
        public TileStyle ImpassableFloor;   // Style for floor under walls (optional, falls back to Impassable)
        ...
        public BoardSkin()
        {
            ...
            ImpassableFloor = null; // Falls back to darker Impassable color
        ...
        public TileStyle GetImpassableFloor()
        {
            return ImpassableFloor ?? new TileStyle(Impassable.Color * 0.5f, null, 1f, 0.1f);
        }
    ...
    public static class BoardSkins
    {
        ...
        private static void InitializePresets()
        {
            ...
            _classicWood = new BoardSkin
            {
                ...
                Impassable = new TileStyle(new Color(0.5f, 0.5f, 0.5f), LoadTexture("Stone1"), tiling: 1f, smoothness: 0.1f),
                ImpassableFloor = new TileStyle(new Color(0.5f, 0.5f, 0.5f), darkWoodTex, tiling: 1f, smoothness: 0.05f),  // Dark ground under walls
            ...
            _colorful = new BoardSkin
            {
                ...
                Impassable = new TileStyle(new Color(0.5f, 0.5f, 0.55f), smoothness: 0.2f),     // Stone gray
                ImpassableFloor = new TileStyle(new Color(0.2f, 0.15f, 0.1f), smoothness: 0.1f), // Dark earth
